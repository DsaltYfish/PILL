...
from model.generator_instruct import Generator
...
def main(
    ...
    adapter_path: str='/data/zfy/output_dir/instruct_fintuned.pth',
    ...
    for i, category in enumerate(categories):
        ...
        for i in range(len(questions)//max_batch_size+1):
            ...
            results = generator.generate(
                prompts,images=images,indicators=indicators, max_gen_len=512, temperature=generation_temperature, top_p=top_p, img_position=img_position
            )
